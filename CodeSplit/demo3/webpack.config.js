...
module.exports = {
  // 注意：
  // 目前这个配置文件针对的是多个入口的情况，可以参考此文件内的 optimization.splitChunks 配置
  // 在项目当中，我们开发的基本是单页面应用，只有一个入口，那配置代码分割，配置以下内容即可：
  ...
  optimization: {
    ...
    splitChunks: {
      ...
      // 以下是默认值
      // minSize: 20000, // 分割代码最小的大小，单位byte
      // minRemainingSize: 0, // 类似于minSize，最后确保提取的文件大小不能为0
      // minChunks: 1, // 至少被引用的次数，满足条件才会代码分割
      // maxAsyncRequests: 30, // 按需加载时并行加载的文件的最大数量
      // maxInitialRequests: 30, // 入口js文件最大并行请求数量
      // enforceSizeThreshold: 50000, // 强制超过50kb一定会单独打包（此时会忽略minRemainingSize、maxAsyncRequests、maxInitialRequests）
